...
<div class="p-4 md:p-6 space-y-6">
    ...
    <form method="GET" action="{{ route('budgets.index') }}" 
        ...
        <input 
            ...
            class="px-3 py-2 rounded-lg bg-gray-800 text-white border border-gray-700 w-full sm:w-auto"
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div class="bg-gray-900 rounded-2xl p-5 border border-gray-800">
            ...
            <h2 class="text-2xl md:text-3xl font-bold text-white mt-1">
                {{ money($totalBudget, 0) }}
            </h2>
        </div>
        ...
        <div class="bg-gray-900 rounded-2xl p-5 border border-gray-800">
            ...
            <h2 class="text-2xl md:text-3xl font-bold text-green-400 mt-1">
    ...
    <div class="grid gap-4">
        ...
        <!-- CARD -->
        <div class="bg-gray-900 border border-gray-800 rounded-2xl p-4 md:p-5 space-y-4">
